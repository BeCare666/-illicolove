        ...
        fr: {
          translation : {
           ...
           "openPUA":`Nous vous invitons  à publier votre annonce sur la page de votre zone géographique de résidence, toutefois, vous pouvez consulter et prendre contact avec tout profil d’une annonce de recherche en dehors de votre zone géographique de résidence.
            ...
            "IDTRANSLATEX37":`Nous vous offrons un système de paiement sécurisé par KKiaPay qui est notre agrégateur de paiement partenaire. Selon votre convenance, rechargez votre compte             par carte de crédit ou par mobile money.  Sous votre profil, cliquez sur le bouton « JE RECHARGE MON COMPTE » et suivez les étapes simplement.`,
...
¡Bienvenida!`,
           ...
           "openPUA":`Le invitamos a publicar su anuncio en la página de su zona geográfica de residencia, sin embargo, puede consultar y ponerse en contacto con cualquier perfil de un anuncio de búsqueda fuera de su zona geográfica de residencia.
            ...
            "IDTRANSLATEX37":` Le ofrecemos un sistema de pago seguro por KKiaPay que es nuestro socio agregador de pagos. Según su conveniencia, cargue su cuenta con tarjeta de crédito o con móvil money.  En su perfil, haga clic en el botón «RECARGAR MI CUENTA» y siga los pasos con facilidad.`,
...
"IDTRANSLATEX9":` Validation of your user account `,
            ...
            "IDTRANSLATEX37":` We offer you a secure payment system by KKiaPay which is our partner payment aggregator. Depending on your convenience, reload your account by credit card or mobile money.  Under your profile, click on the “CHARGE MY ACCOUNT” button and follow the steps simply.`,
